...
/**
 * 描述: 支持remoteTokenServices 负载均衡 2. 支持 获取用户全部信息
 *
 * @author www.zhouwenfang.com
 * @version 1.0
 * @date 2022/03/19 15:58:02
 */
@Slf4j
public class ZwfResourceServerConfigurerAdapter extends ResourceServerConfigurerAdapter {
    ...
    public void configure(ResourceServerSecurityConfigurer resources) {
        ...
        UserAuthenticationConverter userTokenConverter = new ZwfUserAuthenticationConverter();
