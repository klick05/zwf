...
/**
 * 描述: @link https://github.com/spring-projects/spring-security-oauth/pull/1660
 *      重写RedisTokenStore ,主要解决 #1814 oauth2中client_id_to_access数据膨胀问题
 *
 * @author www.zhouwenfang.com
 * @version 1.0
 * @date 2022/03/19 15:54:25
 */
public class ZwfRedisTokenStore implements TokenStore {
    ...
    public ZwfRedisTokenStore(RedisConnectionFactory connectionFactory, KeyStrResolver resolver) {
