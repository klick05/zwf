...
/**
 * 描述: 支持本地模式 [不仅过认证中 CheckToken]的的资源服务器配置
 *
 * @author www.zhouwenfang.com
 * @version 1.0
 * @date 2022/03/19 15:44:29
 */
public class ZwfLocalResourceServerConfigurerAdapter extends ResourceServerConfigurerAdapter {
